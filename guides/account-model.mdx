...
HTTP header names are case-insensitive. Samples in this portal use `X-SUBACCOUNT-ID`. Parent HMAC headers still apply. If this header is missing, you operate the parent account — a common cause of “empty balance” tickets.
